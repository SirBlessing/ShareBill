...
const participants = [
  { initials:"AO", name:"Adeola O.", amount:"₦12,000", statusLabel:"Paid",    avatarColor:"#C026D3", statusClass:"s-paid"    },
  { initials:"TK", name:"Tunde K.",  amount:"₦12,000", statusLabel:"Confirm", avatarColor:"#7C3AED", statusClass:"s-await"   },
  { initials:"BN", name:"Bisi N.",   amount:"₦12,000", statusLabel:"Pending", avatarColor:"#22D3EE", statusClass:"s-pending" },
];

export default function HeroSection() {
  /* ── Auth-aware CTA link ─────────────────────────────────
     If the user is already logged in, send them straight to
     /create-bill. Otherwise take them to /create-account.
  ─────────────────────────────────────────────────────── */
      ...
      <div className="hero-inner">
        ...
        <div className="hero-left">
          ...
          <div className="hero-buttons">
            <Link to={billLink} className="btn-primary">
                ...
                {participants.map((p, i) => (
                  <div className="phone-p-row" key={i}>
                    <div className="phone-p-left">
                      <div className="phone-avatar" style={{ background: p.avatarColor }}>
                        {p.initials}
                      </div>
                      <div>
                    ...
                    <span className={`phone-p-status ${p.statusClass}`}>{p.statusLabel}</span>
                  </div>
                ))}
              </div>
            </div>
